...
void ads1256_write_reg_sync(struct ads1256_chip * chip, uint32_t reg,
		uint8_t data);
void ads1256_write_reg_async(struct ads1256_chip * chip, uint32_t reg,
		uint8_t data);
uint8_t ads1256_read_reg_sync(struct ads1256_chip * chip, uint32_t reg);
uint8_t ads1256_write_then_read_reg_sync(struct ads1256_chip * chip,
...
void ads1256_set_cmds_sync(struct ads1256_chip * chip, uint8_t * cmd,
		uint16_t size);
void ads1256_rdc_read_async(struct ads1256_chip * chip,
		void (* complete)(const struct spi_transfer *));
