...
#define HWCON_IRQ_PRIO_PROBE_SPI            0
#define HWCON_IRQ_PRIO_PROBE_EXTI           1
#define IRQ_PRIO_TRIGGER_OUT_TIM        2
#define HWCON_IRQ_PRIO_SYSTICK              4
#define HWCON_IRQ_PRIO_NEON                 4
#define HWCON_IRQ_PRIO_AUX_SPI              4
#define HWCON_IRQ_PRIO_AUX_EXTI             5
#define HWCON_IRQ_PRIO_RTCOMM_SPI_DMA_TX    6
...
#define HWCON_AUX_NSS_PIN               GPIO_PIN_4
#define HWCON_AUX_NSS_PORT              GPIOA
#define HWCON_AUX_NSS_CLK_ENABLE()      __GPIOA_CLK_ENABLE()
#define HWCON_AUX_NSS_AF                GPIO_AF5_SPI1

#define HWCON_AUX_MISO_PIN              GPIO_PIN_6
#define HWCON_AUX_MISO_PORT             GPIOA
#define HWCON_AUX_MISO_CLK_ENABLE()     __GPIOA_CLK_ENABLE()
#define HWCON_AUX_MISO_AF               GPIO_AF5_SPI1

#define HWCON_AUX_MOSI_PIN              GPIO_PIN_7
#define HWCON_AUX_MOSI_PORT             GPIOA
#define HWCON_AUX_MOSI_CLK_ENABLE()     __GPIOA_CLK_ENABLE()
#define HWCON_AUX_MOSI_AF               GPIO_AF5_SPI1

#define HWCON_AUX_SCK_PIN               GPIO_PIN_5
#define HWCON_AUX_SCK_PORT              GPIOA
#define HWCON_AUX_SCK_CLK_ENABLE()      __GPIOA_CLK_ENABLE()
#define HWCON_AUX_SCK_AF                GPIO_AF5_SPI1
