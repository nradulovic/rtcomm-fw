...
#define HWCON_IRQ_PRIO_ACQ_x_SPI              1
#define HWCON_IRQ_PRIO_ACQ_x_EXTI             1
 ...
 * --  Channel X --------------------------------------------------------------
 */
#define HWCON_ACQ_0_DRDY_PIN            GPIO_PIN_2
#define HWCON_ACQ_0_DRDY_PORT           GPIOD
#define HWCON_ACQ_0_DRDY_CLK_ENABLE()   __GPIOD_CLK_ENABLE()
#define HWCON_ACQ_0_DRDY_EXTI           EXTI2_IRQn
#define HWCON_ACQ_0_DRDY_EXTI_Handler   EXTI2_IRQHandler

#define HWCON_ACQ_0_SPI					g_spi4
#define HWCON_ACQ_0_SPI_CLK_ENABLE()	__SPI4_CLK_ENABLE()
#define HWCON_ACQ_0_SPI_IRQ				SPI4_IRQn
#define HWCON_ACQ_0_SPI_IRQ_Handler		SPI4_IRQHandler
#define HWCON_ACQ_0_SPI_BAUD_CLOCK      SPI_BAUDRATEPRESCALER_64
...
#define HWCON_ACQ_0_SPI_SCK_CLK_ENABLE()	__GPIOE_CLK_ENABLE()
#define HWCON_ACQ_0_SPI_SCK_AF			GPIO_AF5_SPI4

/*
 * --  Channel Y --------------------------------------------------------------
 */
#define HWCON_ACQ_1_DRDY_PIN		    GPIO_PIN_1
#define HWCON_ACQ_1_DRDY_PORT           GPIOD
#define HWCON_ACQ_1_DRDY_CLK_ENABLE()   __GPIOD_CLK_ENABLE()
#define HWCON_ACQ_1_DRDY_EXTI			EXTI1_IRQn
#define HWCON_ACQ_1_DRDY_EXTI_Handler	EXTI1_IRQHandler

#define HWCON_ACQ_1_SPI					g_spi5
#define HWCON_ACQ_1_SPI_CLK_ENABLE()	__SPI5_CLK_ENABLE()
#define HWCON_ACQ_1_SPI_IRQ				SPI5_IRQn
#define HWCON_ACQ_1_SPI_IRQ_Handler		SPI5_IRQHandler
#define HWCON_ACQ_1_SPI_BAUD_CLOCK      SPI_BAUDRATEPRESCALER_64

#define HWCON_ACQ_1_SPI_NSS_PIN			GPIO_PIN_4
#define HWCON_ACQ_1_SPI_NSS_PORT		GPIOE
#define HWCON_ACQ_1_SPI_NSS_CLK_ENABLE()	__GPIOE_CLK_ENABLE()

#define HWCON_ACQ_1_SPI_MISO_PIN		GPIO_PIN_5
#define HWCON_ACQ_1_SPI_MISO_PORT		GPIOE
#define HWCON_ACQ_1_SPI_MISO_CLK_ENABLE()	__GPIOE_CLK_ENABLE()
#define HWCON_ACQ_1_SPI_MISO_AF			GPIO_AF6_SPI5

#define HWCON_ACQ_1_SPI_MOSI_PIN		GPIO_PIN_6
#define HWCON_ACQ_1_SPI_MOSI_PORT		GPIOE
#define HWCON_ACQ_1_SPI_MOSI_CLK_ENABLE()	__GPIOE_CLK_ENABLE()
#define HWCON_ACQ_1_SPI_MOSI_AF			GPIO_AF6_SPI5

#define HWCON_ACQ_1_SPI_SCK_PIN			GPIO_PIN_2
#define HWCON_ACQ_1_SPI_SCK_PORT		GPIOE
#define HWCON_ACQ_1_SPI_SCK_CLK_ENABLE()	__GPIOE_CLK_ENABLE()
#define HWCON_ACQ_1_SPI_SCK_AF			GPIO_AF6_SPI5

/*
 * --  Channel Z --------------------------------------------------------------
 */
#define HWCON_ACQ_2_DRDY_PIN			GPIO_PIN_0
#define HWCON_ACQ_2_DRDY_PORT           GPIOD
#define HWCON_ACQ_2_DRDY_CLK_ENABLE()   __GPIOD_CLK_ENABLE()
#define HWCON_ACQ_2_DRDY_EXTI			EXTI0_IRQn
#define HWCON_ACQ_2_DRDY_EXTI_Handler	EXTI0_IRQHandler

#define HWCON_ACQ_2_SPI					g_spi2
#define HWCON_ACQ_2_SPI_CLK_ENABLE()	__SPI2_CLK_ENABLE()
#define HWCON_ACQ_2_SPI_IRQ				SPI2_IRQn
#define HWCON_ACQ_2_SPI_IRQ_Handler		SPI2_IRQHandler
#define HWCON_ACQ_2_SPI_BAUD_CLOCK      SPI_BAUDRATEPRESCALER_32

#define HWCON_ACQ_2_SPI_NSS_PIN			GPIO_PIN_12
#define HWCON_ACQ_2_SPI_NSS_PORT		GPIOB
#define HWCON_ACQ_2_SPI_NSS_CLK_ENABLE()	__GPIOB_CLK_ENABLE()

#define HWCON_ACQ_2_SPI_MISO_PIN		GPIO_PIN_14
#define HWCON_ACQ_2_SPI_MISO_PORT		GPIOB
#define HWCON_ACQ_2_SPI_MISO_CLK_ENABLE()	__GPIOB_CLK_ENABLE()
#define HWCON_ACQ_2_SPI_MISO_AF			GPIO_AF5_SPI2

#define HWCON_ACQ_2_SPI_MOSI_PIN		GPIO_PIN_15
#define HWCON_ACQ_2_SPI_MOSI_PORT		GPIOB
#define HWCON_ACQ_2_SPI_MOSI_CLK_ENABLE()	__GPIOB_CLK_ENABLE()
#define HWCON_ACQ_2_SPI_MOSI_AF			GPIO_AF5_SPI2

#define HWCON_ACQ_2_SPI_SCK_PIN			GPIO_PIN_13
#define HWCON_ACQ_2_SPI_SCK_PORT		GPIOB
#define HWCON_ACQ_2_SPI_SCK_CLK_ENABLE()	__GPIOB_CLK_ENABLE()
#define HWCON_ACQ_2_SPI_SCK_AF			GPIO_AF5_SPI2
